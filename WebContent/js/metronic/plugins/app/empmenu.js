...
function loadMenu(){
	var json='[{"id": "1","name": "CSI员工之家","icon": null,"url": "","parentId": "",'
		...
		+'"childs": []},{"id": "172","name": "上传文档","icon": "","url": "document/showAddDocument.html","parentId": "17",'
		...
		+'"childs": [{"id": "191","name": "查看月报","icon": "","url": "document/document.html","parentId": "19",'
		+'"childs": []}]},{"id": "20","name": "请假申请管理","icon": "/xingxing.png","url": "document/document.html","parentId": "1",'
		+'"childs": [{"id": "201","name": "请假查询","icon": "","url": "document/document.html","parentId": "20",'
		+'"childs": []}]},{"id": "21","name": "外出申请管理","icon": "/xingxing.png","url": "notice/notice.html","parentId": "1",'
		+'"childs": [{"id": "211","name": "外出查询","icon": "","url": "notice/notice.html","parentId": "21",'
