		...
		<tbody>
			...
			<tr>
				...
				<td class="main_locbg font2"><img
					...
					&gt; 修改员工</td>
				<td width="15" height="32"><img src="${pageContext.request.contextPath}/images/main_locright.gif"
						 width="15" height="32"></td>
			</tr>
		</tbody>
	</table>
		...
		<tbody>
			<tr valign="top">
				<td>
					...
					<form action="${pageContext.request.contextPath}/UpdateEmpSvl" method="POST">
						...
						<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
							<tbody>
								<tr valign="top">
									<td>
										<!-- 隐藏表单，flag表示添加标记 --> <input type="hidden" name="flag" value="2"> <input
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="10"
											...
											<tbody>
																...
																<tr>
																	<td class="font3 fftd">性别： <select id="sex"
																			...
																			<c:if test="${emp.sex } ne '1'">
																				...
																				<option value="2" selected="selected">女
																				</option>
																			</c:if>
																		</select>
																	</td>
																	<td class="font3 fftd">
																		...
																		<select id="job_id" name="job_id"
																				style="width: 143px;">
																			<c:forEach var="job"
																					   items="${requestScope.jobs }">
																				<option value="${job.jobid }">${job.jobname}
																				</option>
																			</c:forEach>
												...
												<tr>
													<td class="font3 fftd">政治面貌：<input name="party" id="party" size="40"
															   value="${emp.party }">&nbsp;&nbsp;
												...
												<tr>
													<td class="font3 fftd">联系地址：<input name="address" id="address"
															   size="40" value="${emp.address }">&nbsp;&nbsp;
												...
												<tr>
													<td class="font3 fftd">所学专业：<input name="speciality" id="speciality"
															   size="40" value="${emp.speciality}">&nbsp;&nbsp;
														爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="hobby" id="hobby"
															   size="20" value="${emp.hobby }">
													</td>
												</tr>
												<tr>
													<td class="main_tdbor"></td>
												...
												<tr>
													<td class="font3 fftd">备&nbsp;&nbsp;&nbsp;&nbsp;注：<input
														...
														&nbsp;&nbsp;所属部门： <select name="dept_id" style="width: 100px;">
															...
															<c:forEach var="dep" items="${requestScope.deps }">
																<c:if test="${dep.depid } eq ${emp.depId }">
																	<option value="${dep.depid }" selected="selected">
																		${dep.depname}</option>
																</c:if>
																<c:if test="${dep.depid } ne ${emp.depId }">
																	<option value="${dep.depid }">${dep.depname}
																	</option>
																</c:if>
															</c:forEach>
