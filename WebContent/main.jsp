...
<html>
	...
	<body class="layout-fixed">
				...
				<div class="navbar-header" style="width:20%;text-align: left;">
					<span class="navbar-brand navbar-brand-h" >
		        		<div class="brand-text" style="padding-top: 3px;">
							...
							<span style="font-family:'Britannic Bold', 'Britannic';color:#3BC5BB;">CIST员工</span>
		...
		<div class="nav-wrapper">
			...
			<!-- 以下是隱藏的内容 -->
			<li>
				<input type="hidden" id="main_emprole" value="${sessionScope.empentity.role }" />
				<input type="hidden" id="main_role" value="${sessionScope.emprole }" />
			</li>
				<li>
					<a>
						<span class="user-name-csdc">欢迎登录：${sessionScope.empentity.empname}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<li class="dropdown">
					<a class="menu-icons" title="退出登录" data-no-persist="true" onclick="sessionStorage.clear();window.location.href='LoginOutSvl'">
