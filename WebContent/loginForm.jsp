					...
					<div class="content">
						...
						<div class="formoperate">
							<span class="rememberPwd"> <input type="checkbox"
								id="rememberPwd" /><label for="rememberPwd">记住密码</label> <font
								style="color: red">${requestScope.msg}</font>
							</span>
						</div>
						<div>
							<button type="buttion" id="login-submit-btn"
							...
							<button type="button" title="刷脸登录" data-search-open=""
								...
								data-href="face/login_face.jsp" data-width="780"
								data-height="500" class="layui-btn  btn-login"
