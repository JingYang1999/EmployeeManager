...
<html>
	...
	function submit(){
	      ...
	      // $("#noticeForm").submit(function(){
				...
				$.ajax({
					...
					data:{"noticename":title.val(),"noticecontent":content.val(),"empid":empid.val()},//要传给服务器的参数
					dataType:"json",//若知此次请求的返回值是json串
					success:function(data){//请求成功时调用，data是请求成功时返回的数据
						//对返回值的操作
						if(data==true){alert("公告添加成功");}
						else{alert("公告添加失败");}
					}
				})
	        	//$("#noticeForm").submit();
	...
	<body>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
			    <form action="${pageContext.request.contextPath }/AddNoticeSvl" method="post">
				  <!-- 隐藏表单，flag表示添加标记 -->
		...
		<div style="height:10px;"><font>${requestScope.result}</font></div>
	</body>
</html>